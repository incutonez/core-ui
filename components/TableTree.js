...
import { F as Pe, _ as vt, a as se } from "../FieldComboBox.vue_vue_type_script_setup_true_lang-Bj6FjxqF.js";
...
import { s as Tt, a as xe, b as Ke, c as Ee } from "../index-T0Tl3u9Q.js";
...
import { _ as Ht } from "../TableCellMenu.vue_vue_type_script_setup_true_lang-DEJRFNzV.js";
import { clone as _t, isEmpty as je } from "../utils/common.js";
import { useDataTable as $t, RowsPerPageOptions as Ut } from "../utils/table.js";
var Vt = function(e) {
  var t = e.dt;
  return `
.p-treetable {
...
Ze.render = Kn;
const En = { class: "flex" }, jn = { key: 0 }, In = { class: "ml-auto flex gap-x-2" }, Rn = { class: "flex items-center justify-between" }, Fn = { class: "flex items-center gap-x-2" }, Dn = { class: "text-sm" }, Nn = { class: "text-sm" }, ir = /* @__PURE__ */ mt({
  __name: "TableTree",
  props: {
    records: {},
    title: {},
  ...
  setup(n, { expose: e, emit: t }) {
    ...
    function Se() {
      const S = m(ae), F = Object.keys(S), k = _t(v.value);
