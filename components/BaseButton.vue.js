...
`);
  ...
  root: function(t) {
    ...
    return ["p-badge p-component", {
      "p-badge-circle": E(n.value) && String(n.value).length === 1,
      "p-badge-dot": x(n.value) && !r.$slots.default,
    ...
    default: k(function() {
      return [d(o.$slots, "default", {}, function() {
        return [o.loading ? d(o.$slots, "loadingicon", {
          ...
          }, o.ptm("loadingIcon")), null, 16)) : (a(), u(z, e({
            key: 1,
          ...
          }, o.ptm("icon")), null, 16)) : h("", !0)];
        }), v("span", e({
          class: o.cx("label")
        }, o.ptm("label")), f(o.label || " "), 17), o.badge ? (a(), u(S, e({
          key: 2,
          value: o.badge,
          class: o.badgeClass,
          severity: o.badgeSeverity,
          unstyled: o.unstyled
        }, o.ptm("pcBadge")), null, 16, ["value", "class", "severity", "unstyled"])) : h("", !0)];
      })];
    }),
    _: 3
  }, 16, ["class"])), [[I]]);
  ...
  setup(o) {
    return (t, n) => (a(), u(O($), {
      ...
      icon: k(() => [
        d(t.$slots, "icon", {}, () => [
          (a(), u(y(t.icon), {
            class: i(["mr-0.5 size-4", t.iconCls])
          }, null, 8, ["class"]))
        ])
      ]),
      _: 3
