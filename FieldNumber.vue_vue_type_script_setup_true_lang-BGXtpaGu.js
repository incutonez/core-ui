import { openBlock as m, createElementBlock as w, mergeProps as d, createElementVNode as S, resolveComponent as H, createVNode as O, normalizeClass as _, normalizeStyle as Z, renderSlot as g, toHandlers as x, createBlock as I, resolveDynamicComponent as B, createCommentVNode as $, defineComponent as q, mergeModels as E, useModel as J, computed as Q, normalizeProps as X, guardReactiveProps as Y, withCtx as ee, unref as te } from "vue";
import { B as ne, c as L, a2 as N, k as ie, i as re, s as ue } from "./index-CJIVb0yO.js";
import { s as R } from "./index-C7l8zMDA.js";
import { s as se } from "./index-BXMTLA5w.js";
import { _ as ae } from "./BaseField.vue_vue_type_script_setup_true_lang-LU5T51M2.js";
var T = {
  name: "AngleDownIcon",
  extends: R
};
...
function A(n) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? U(Object(t), !0).forEach(function(i) {
      he(n, i, t[i]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t)) : U(Object(t)).forEach(function(i) {
...
function he(n, e, t) {
  return (e = fe(e)) in n ? Object.defineProperty(n, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : n[e] = t, n;
}
function fe(n) {
  var e = be(n, "string");
...
var j = {
  ...
  methods: {
    ...
    constructParser: function() {
      ...
      var e = ge(new Intl.NumberFormat(this.locale, {
        useGrouping: !1
    ...
    getDecimalExpression: function() {
      var e = new Intl.NumberFormat(this.locale, A(A({}, this.getOptions()), {}, {
        useGrouping: !1
      }));
    ...
    spin: function(e, t) {
      if (this.$refs.input) {
        var i = this.step * t, u = this.parseValue(this.$refs.input.$el.value) || 0, r = this.validateValue(u + i);
    ...
    onInputKeyDown: function(e) {
      if (!this.readonly) {
        ...
        var t = e.target.selectionStart, i = e.target.selectionEnd, u = e.target.value, r = null;
        switch (e.code) {
          case "ArrowUp":
          ...
          case "ArrowDown":
            ...
            break;
          case "ArrowLeft":
            this.isNumeralChar(u.charAt(t - 1)) || e.preventDefault();
            break;
          case "ArrowRight":
            this.isNumeralChar(u.charAt(t)) || e.preventDefault();
            break;
          case "Tab":
          case "Enter":
          case "NumpadEnter":
            r = this.validateValue(this.parseValue(u)), this.$refs.input.$el.value = this.formatValue(r), this.$refs.input.$el.setAttribute("aria-valuenow", r), this.updateModel(e, r);
            break;
          case "Backspace": {
            if (e.preventDefault(), t === i) {
              var s = u.charAt(t - 1), a = this.getDecimalCharIndexes(u), p = a.decimalCharIndex, c = a.decimalCharIndexWithoutPrefix;
              if (this.isNumeralChar(s)) {
                var b = this.getDecimalLength(u);
                if (this._group.test(s))
                  this._group.lastIndex = 0, r = u.slice(0, t - 2) + u.slice(t - 1);
                else if (this._decimal.test(s))
                  this._decimal.lastIndex = 0, b ? this.$refs.input.$el.setSelectionRange(t - 1, t - 1) : r = u.slice(0, t - 1) + u.slice(t);
                else if (p > 0 && t > p) {
                  var o = this.isDecimalMode() && (this.minFractionDigits || 0) < b ? "" : "0";
                  r = u.slice(0, t - 1) + o + u.slice(t);
                } else c === 1 ? (r = u.slice(0, t - 1) + "0" + u.slice(t), r = this.parseValue(r) > 0 ? r : "") : r = u.slice(0, t - 1) + u.slice(t);
              }
              this.updateValue(e, r, null, "delete-single");
            } else
              r = this.deleteRange(u, t, i), this.updateValue(e, r, null, "delete-range");
            break;
          }
          case "Delete":
            if (e.preventDefault(), t === i) {
              var h = u.charAt(t), l = this.getDecimalCharIndexes(u), y = l.decimalCharIndex, v = l.decimalCharIndexWithoutPrefix;
              if (this.isNumeralChar(h)) {
                var f = this.getDecimalLength(u);
                if (this._group.test(h))
                  this._group.lastIndex = 0, r = u.slice(0, t) + u.slice(t + 2);
                else if (this._decimal.test(h))
                  this._decimal.lastIndex = 0, f ? this.$refs.input.$el.setSelectionRange(t + 1, t + 1) : r = u.slice(0, t) + u.slice(t + 1);
                else if (y > 0 && t > y) {
                  var D = this.isDecimalMode() && (this.minFractionDigits || 0) < f ? "" : "0";
                  r = u.slice(0, t) + D + u.slice(t + 1);
                } else v === 1 ? (r = u.slice(0, t) + "0" + u.slice(t + 1), r = this.parseValue(r) > 0 ? r : "") : r = u.slice(0, t) + u.slice(t + 1);
              }
            ...
            break;
          case "Home":
            e.preventDefault(), L(this.min) && this.updateModel(e, this.min);
            break;
          case "End":
            e.preventDefault(), L(this.max) && this.updateModel(e, this.max);
            break;
        }
      }
    },
    ...
    insert: function(e, t) {
      ...
      if (this._minusSign.lastIndex = 0, !(!this.allowMinusSign() && u !== -1)) {
        var r = this.$refs.input.$el.selectionStart, s = this.$refs.input.$el.selectionEnd, a = this.$refs.input.$el.value.trim(), p = this.getCharIndexes(a), c = p.decimalCharIndex, b = p.minusCharIndex, o = p.suffixCharIndex, h = p.currencyCharIndex, l;
        if (i.isMinusSign)
          r === 0 && (l = a, (b === -1 || s !== 0) && (l = this.insertText(a, t, 0, s)), this.updateValue(e, l, t, "insert"));
        else if (i.isDecimalSign)
          c > 0 && r === c ? this.updateValue(e, a, t, "insert") : c > r && c < s ? (l = this.insertText(a, t, r, s), this.updateValue(e, l, t, "insert")) : c === -1 && this.maxFractionDigits && (l = this.insertText(a, t, r, s), this.updateValue(e, l, t, "insert"));
        else {
          var y = this.numberFormat.resolvedOptions().maximumFractionDigits, v = r !== s ? "range-insert" : "insert";
          if (c > 0 && r > c) {
            if (r + t.length - (c + 1) <= y) {
              var f = h >= r ? h - 1 : o >= r ? o : a.length;
              l = a.slice(0, r) + t + a.slice(r + t.length, f) + a.slice(f), this.updateValue(e, l, t, v);
            }
          } else
            l = this.insertText(a, t, r, s), this.updateValue(e, l, t, v);
        }
      }
    },
    ...
    updateInput: function(e, t, i, u) {
      t = t || "";
      var r = this.$refs.input.$el.value, s = this.formatValue(e), a = r.length;
      if (s !== u && (s = this.concatValues(s, u)), a === 0) {
        this.$refs.input.$el.value = s, this.$refs.input.$el.setSelectionRange(0, 0);
        var p = this.initCursor(), c = p + t.length;
        this.$refs.input.$el.setSelectionRange(c, c);
      } else {
        var b = this.$refs.input.$el.selectionStart, o = this.$refs.input.$el.selectionEnd;
        this.$refs.input.$el.value = s;
        var h = s.length;
        if (i === "range-insert") {
          var l = this.parseValue((r || "").slice(0, b)), y = l !== null ? l.toString() : "", v = y.split("").join("(".concat(this.groupChar, ")?")), f = new RegExp(v, "g");
          f.test(s);
          var D = t.split("").join("(".concat(this.groupChar, ")?")), M = new RegExp(D, "g");
          M.test(s.slice(f.lastIndex)), o = f.lastIndex + M.lastIndex, this.$refs.input.$el.setSelectionRange(o, o);
        } else if (h === a)
          ...
          var G = r.charAt(o - 1), z = r.charAt(o), k = a - h, P = this._group.test(z);
          P && k === 1 ? o += 1 : !P && this.isNumeralChar(G) && (o += -1 * k + 1), this._group.lastIndex = 0, this.$refs.input.$el.setSelectionRange(o, o);
        } else if (r === "-" && i === "insert") {
          this.$refs.input.$el.setSelectionRange(0, 0);
          var W = this.initCursor(), F = W + t.length + 1;
          this.$refs.input.$el.setSelectionRange(F, F);
        } else
          o = o + (h - a), this.$refs.input.$el.setSelectionRange(o, o);
      }
    ...
    onInputBlur: function(e) {
      ...
      this.$emit("blur", {
        originalEvent: e,
        value: t.value
      }), t.value = this.formatValue(i), t.setAttribute("aria-valuenow", i), this.updateModel(e, i), !this.disabled && !this.readonly && this.highlightOnFocus && ie();
    },
    clearTimer: function() {
  ...
  computed: {
    ...
    hasFluid: function() {
      return re(this.fluid) ? !!this.$pcFluid : this.fluid;
    }
  },
  components: {
    InputText: se,
...
}, Ce = ["disabled"], xe = ["disabled"], Be = ["disabled"], Se = ["disabled"];
function De(n, e, t, i, u, r) {
  ...
  return m(), w("span", d({
    ...
    id: n.inputId,
    role: "spinbutton",
    class: _([n.cx("pcInput"), n.inputClass]),
    style: Z(n.inputStyle),
    ...
    pt: n.ptm("pcInput"),
    unstyled: n.unstyled
  }, null, 8, ["id", "class", "style", "value", "aria-valuemin", "aria-valuemax", "aria-valuenow", "inputmode", "disabled", "readonly", "placeholder", "aria-labelledby", "aria-label", "invalid", "variant", "onInput", "onKeydown", "onKeypress", "onPaste", "onClick", "onFocus", "onBlur", "pt", "unstyled"]), n.showButtons && n.buttonLayout === "stacked" ? (m(), w("span", d({
    key: 0,
    class: n.cx("buttonGroup")
  }, n.ptm("buttonGroup")), [g(n.$slots, "incrementbutton", {
    listeners: r.upButtonListeners
  }, function() {
    return [S("button", d({
      class: [n.cx("incrementButton"), n.incrementButtonClass]
    }, x(r.upButtonListeners, !0), {
      disabled: n.disabled,
      tabindex: -1,
      "aria-hidden": "true",
      type: "button"
    }, n.ptm("incrementButton")), [g(n.$slots, n.$slots.incrementicon ? "incrementicon" : "incrementbuttonicon", {}, function() {
      return [(m(), I(B(n.incrementIcon || n.incrementButtonIcon ? "span" : "AngleUpIcon"), d({
        class: [n.incrementIcon, n.incrementButtonIcon]
      }, n.ptm("incrementIcon"), {
        "data-pc-section": "incrementicon"
      }), null, 16, ["class"]))];
    })], 16, Ce)];
  }), g(n.$slots, "decrementbutton", {
    listeners: r.downButtonListeners
  }, function() {
    return [S("button", d({
      class: [n.cx("decrementButton"), n.decrementButtonClass]
    }, x(r.downButtonListeners, !0), {
      disabled: n.disabled,
      tabindex: -1,
      "aria-hidden": "true",
      type: "button"
    }, n.ptm("decrementButton")), [g(n.$slots, n.$slots.decrementicon ? "decrementicon" : "decrementbuttonicon", {}, function() {
      return [(m(), I(B(n.decrementIcon || n.decrementButtonIcon ? "span" : "AngleDownIcon"), d({
        class: [n.decrementIcon, n.decrementButtonIcon]
      }, n.ptm("decrementIcon"), {
        "data-pc-section": "decrementicon"
      }), null, 16, ["class"]))];
    })], 16, xe)];
  })], 16)) : $("", !0), g(n.$slots, "incrementbutton", {
    listeners: r.upButtonListeners
  }, function() {
...
const Fe = /* @__PURE__ */ q({
  ...
  emits: /* @__PURE__ */ E(["inputEnd"], ["update:modelValue"]),
  setup(n, { emit: e }) {
    const t = n, i = e, u = J(n, "modelValue");
    let r;
    const s = Q(() => ({
      [t.inputWidth]: !0,
      [t.inputCls]: !0
    ...
    function a() {
      clearTimeout(r), r = setTimeout(() => i("inputEnd"), t.delay);
    }
    return (p, c) => (m(), I(ae, X(Y(p.$props)), {
      default: ee(() => [
        O(te(j), {
          modelValue: u.value,
          ...
          min: p.min,
          max: p.max,
          "min-fraction-digits": p.decimalPlaces,
          onKeyup: a
